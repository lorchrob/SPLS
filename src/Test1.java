...
class Test1 {
  ...
  public static void initializePath(int[][] path) {
   ...
   initializePathHelper(path, 0, 0, 23, 23, k, 0);
  }
  ...
  public static void fillSlot(Integer[][] arr, int rowNum, int colNum, int mark, ArrayList<Integer> previousValues) {
    ...
    case 1:
      // add C_1, C_2
      /*
       * while (!elementOf(arr, randNum, 0, 6, 5, 7) || !checkSlotGeneral(arr,
       * randNum, rowNum, colNum)) { values.remove((Integer) randNum);
       * previousValues.add((Integer) randNum); randNum =
    ...
    case 2:
      // add D_2, D_4
      /*
       * while (elementOf(arr, randNum, 0, 8, 5, 8) || !checkSlotGeneral(arr, randNum,
       * rowNum, colNum)) { values.remove((Integer) randNum);
       * previousValues.add((Integer) randNum); randNum =
       * values.get(rand.nextInt(values.size())); }
       */
    ...
    case 3:
      // add C_3, C_4
      /*
       * while ((!elementOf(arr, randNum, 0, 8, 5, 8) && !elementOf(arr, randNum, 0,
       * 15, 5, 15)) || !checkSlotGeneral(arr, randNum, rowNum, colNum)) {
    ...
    case 4:
      // add B_2, B_4
      /*
       * while (!elementOf(arr, randNum, 6, 18, 7, 23) || !checkSlotGeneral(arr,
       * randNum, rowNum, colNum)) { values.remove((Integer) randNum);
       * previousValues.add((Integer) randNum); randNum =
       * values.get(rand.nextInt(values.size())); }
       */
    ...
    case 5:
      ...
      /*
       * while (elementOf(arr, randNum, 8, 18, 8, 23) || !checkSlotGeneral(arr,
       * randNum, rowNum, colNum)) { values.remove((Integer) randNum);
       * previousValues.add((Integer) randNum); randNum =
       * values.get(rand.nextInt(values.size())); }
       */
    ...
    case 6:
      ...
      /*
       * while ((!elementOf(arr, randNum, 8, 18, 8, 23) && !elementOf(arr, randNum,
       * 15, 18, 15, 23)) || !checkSlotGeneral(arr, randNum, rowNum, colNum)) {
       * values.remove((Integer) randNum); previousValues.add((Integer) randNum);
       * randNum = values.get(rand.nextInt(values.size())); }
       */
      randNum = fillSlotHelper(arr, randNum, rowNum, colNum, values, previousValues, rand, 8, 18, 8, 23, 15, 18, 15, 23, true);
      break;
    case 7:
      // add first rotated B_2, B_4
      /*
       * while (!elementOf(arr, randNum, 18, 16, 23, 17) || !checkSlotGeneral(arr,
       * randNum, rowNum, colNum)) { values.remove((Integer) randNum);
       * previousValues.add((Integer) randNum); randNum =
       * values.get(rand.nextInt(values.size())); }
       */
    ...
    case 8:
      ...
      /*
       * while (elementOf(arr, randNum, 18, 15, 23, 15) || !checkSlotGeneral(arr,
       * randNum, rowNum, colNum)) { values.remove((Integer) randNum);
       * previousValues.add((Integer) randNum); randNum =
       * values.get(rand.nextInt(values.size())); }
       */
    ...
    case 9:
      ...
      /*
       * while ((!elementOf(arr, randNum, 18, 8, 23, 8) && !elementOf(arr, randNum,
       * 18, 15, 23, 15)) || !checkSlotGeneral(arr, randNum, rowNum, colNum)) {
       * values.remove((Integer) randNum); previousValues.add((Integer) randNum);
       * randNum = values.get(rand.nextInt(values.size())); }
       */
      randNum = fillSlotHelper(arr, randNum, rowNum, colNum, values, previousValues, rand, 18, 8, 23, 8, 18, 15, 23, 15, true);
      break;
    case 10:
      // add second rotated B_2, B_4
      /*
       * while (!elementOf(arr, randNum, 16, 0, 17, 5) || !checkSlotGeneral(arr,
       * randNum, rowNum, colNum)) { values.remove((Integer) randNum);
       * previousValues.add((Integer) randNum); randNum =
       * values.get(rand.nextInt(values.size())); }
       */
    ...
    case 11:
      ...
      /*
       * while (elementOf(arr, randNum, 15, 0, 15, 5) || !checkSlotGeneral(arr,
       * randNum, rowNum, colNum)) { values.remove((Integer) randNum);
       * previousValues.add((Integer) randNum); randNum =
       * values.get(rand.nextInt(values.size())); }
       */
    ...
    case 12:
      ...
      /*
       * while ((!elementOf(arr, randNum, 15, 0, 15, 5) && !elementOf(arr, randNum, 8,
       * 0, 8, 5)) || !checkSlotGeneral(arr, randNum, rowNum, colNum)) {
       * values.remove((Integer) randNum); previousValues.add((Integer) randNum);
       * randNum = values.get(rand.nextInt(values.size())); }
       */
      randNum = fillSlotHelper(arr, randNum, rowNum, colNum, values, previousValues, rand, 15, 0, 15, 5, 8, 0, 8, 5, true);
      break;
    }
